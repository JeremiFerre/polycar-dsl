...
public class EnvironmentEventItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addActionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_EnvironmentEvent_action_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_EnvironmentEvent_action_feature",
								"_UI_EnvironmentEvent_type"),
						PolycarPackage.Literals.ENVIRONMENT_EVENT__ACTION, true, false, true, null, null, null));
	}
