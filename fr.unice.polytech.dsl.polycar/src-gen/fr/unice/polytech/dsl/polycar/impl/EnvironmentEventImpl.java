 ...
 * @generated
 */
public class EnvironmentEventImpl extends MinimalEObjectImpl.Container implements EnvironmentEvent {
	/**
	 ...
	 * @ordered
	 */
	protected static final EventType TYPE_EDEFAULT = EventType.TRAFFIC_LIGHT_ON;
	...
	protected EClass eStaticClass() {
		return PolycarPackage.Literals.ENVIRONMENT_EVENT;
	}
	...
	public void setType(EventType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PolycarPackage.ENVIRONMENT_EVENT__TYPE, oldType,
					type));
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case PolycarPackage.ENVIRONMENT_EVENT___REACT:
			react();
			return null;
		}
