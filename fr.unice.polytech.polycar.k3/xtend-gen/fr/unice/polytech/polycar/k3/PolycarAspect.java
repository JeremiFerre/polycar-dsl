...
public class PolycarAspect {
  ...
  public static void run(final Car _self) {
    final fr.unice.polytech.polycar.k3.PolycarAspectCarAspectProperties _self_ = fr.unice.polytech.polycar.k3.PolycarAspectCarAspectContext.getSelf(_self);
    // #DispatchPointCut_before# void run()
    if (_self instanceof fr.unice.polytech.polycar.Car){
    	fr.unice.polytech.polycar.k3.PolycarAspect._privk3_run(_self_, (fr.unice.polytech.polycar.Car)_self);
    };
  }
