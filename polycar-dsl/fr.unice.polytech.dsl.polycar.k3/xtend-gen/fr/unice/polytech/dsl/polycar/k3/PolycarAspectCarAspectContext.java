...
public class PolycarAspectCarAspectContext {
  ...
  public static PolycarAspectCarAspectProperties getSelf(final Car _self) {
    		if (!INSTANCE.map.containsKey(_self))
    			INSTANCE.map.put(_self, new fr.unice.polytech.dsl.polycar.k3.PolycarAspectCarAspectProperties());
    		return INSTANCE.map.get(_self);
  }
  
  private Map<Car, PolycarAspectCarAspectProperties> map = new java.util.WeakHashMap<fr.unice.polytech.dsl.polycar.Car, fr.unice.polytech.dsl.polycar.k3.PolycarAspectCarAspectProperties>();
