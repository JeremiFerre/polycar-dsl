...
public class PolycarParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, PolycarGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getCarAccess().getConditionsAssignment_9(), "rule__Car__ConditionsAssignment_9");
			builder.put(grammarAccess.getCarAccess().getConditionsAssignment_10(), "rule__Car__ConditionsAssignment_10");
			builder.put(grammarAccess.getCarAccess().getDefaultActionAssignment_12(), "rule__Car__DefaultActionAssignment_12");
			builder.put(grammarAccess.getConditionAccess().getEnvironmentEventsAssignment_1_1(), "rule__Condition__EnvironmentEventsAssignment_1_1");
			builder.put(grammarAccess.getConditionAccess().getEnvironmentEventsAssignment_2_1(), "rule__Condition__EnvironmentEventsAssignment_2_1");
			builder.put(grammarAccess.getConditionAccess().getActionAssignment_4(), "rule__Condition__ActionAssignment_4");
			...
			builder.put(grammarAccess.getEnvironmentEventAccess().getTypeAssignment_1(), "rule__EnvironmentEvent__TypeAssignment_1");
