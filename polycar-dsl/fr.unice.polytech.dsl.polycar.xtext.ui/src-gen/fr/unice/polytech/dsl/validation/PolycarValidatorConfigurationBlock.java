 ...
 */
package fr.unice.polytech.dsl.validation;
...
public class PolycarValidatorConfigurationBlock extends AbstractValidatorConfigurationBlock {

	@Override
	protected void fillSettingsPage(Composite composite, int nColumns, int defaultIndent) {
		addComboBox(PolycarConfigurableIssueCodesProvider.DEPRECATED_MODEL_PART, "Deprecated Model Part", composite, defaultIndent);
	}
	...
	protected IDialogSettings getDialogSettings() {
		...
		IDialogSettings section = dialogSettings.getSection("Polycar");
		if (section == null) {
			return dialogSettings.addNewSection("Polycar");
		}
		return section;
	}
}
