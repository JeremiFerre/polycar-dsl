 ...
 *   <li>{@link fr.unice.polytech.dsl.polycar.impl.CarImpl#getConditions <em>Conditions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CarImpl extends NamedElementImpl implements Car {
	...
	public EList<Condition> getConditions() {
		if (conditions == null) {
			conditions = new EObjectContainmentEList<Condition>(Condition.class, this, PolycarPackage.CAR__CONDITIONS);
		}
		return conditions;
	}
